...
from load_data import load_data_predict,load_final_test_data,create_voabulary,create_voabulary_label
...
tf.app.flags.DEFINE_integer("validate_every", 3, "Validate every validate_every epochs.") 
