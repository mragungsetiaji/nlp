...
echo '192.168.31.176 n01-hdp.kadence.local' >> /etc/hosts
echo '192.168.31.179 n02-hdp.kadence.local' >> /etc/hosts
echo '192.168.31.180 n03-hdp.kadence.local' >> /etc/hosts
